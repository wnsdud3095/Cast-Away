...
public class CraftIngredientSlotPresenter : IDisposable
{
    private readonly ICraftIngredientSlotView m_view;
    private readonly IngredientData m_ingredient_data;
    private readonly IInventoryService m_inventory_service;

    public CraftIngredientSlotPresenter(ICraftIngredientSlotView view,
