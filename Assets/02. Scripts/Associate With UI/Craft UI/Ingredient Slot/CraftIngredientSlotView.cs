...
public class CraftIngredientSlotView : MonoBehaviour, ICraftIngredientSlotView
{
    [Header("UI 관련 컴포넌트")]
    [Header("아이템 이름")]
    ...
    private CraftIngredientSlotPresenter m_presenter;
    ...
    public void Inject(CraftIngredientSlotPresenter presenter)
    {
