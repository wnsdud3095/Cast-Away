...
public class ShortcutUIInstaller : MonoBehaviour, IInstaller
{
    ...
    public void Install()
    {
        ...
        var shortcut_presenters = new List<ShortcutSlotPresenter>();
        ...
        DIContainer.Register<List<ShortcutSlotPresenter>>(shortcut_presenters);
    }
}
